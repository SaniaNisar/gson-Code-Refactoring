 ...
 * then on serialization should prefer {@code JsonSerializer} over reflective adapter for Subclass.
 *//*
 ...
 * is registered for Base, then Gson should prefer the reflective adapter for Subclass for backward
 * compatibility (see https://github.com/google/gson/pull/1787#issuecomment-1222175189) even though
 * normally TypeAdapterRuntimeTypeWrapper should prefer the custom serializer for Base.
 *//*
